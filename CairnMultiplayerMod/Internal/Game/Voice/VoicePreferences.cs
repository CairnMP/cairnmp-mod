...
internal static class VoicePreferences
{
    ...
    internal static MelonPreferences_Entry<bool> EnhanceMicrophone;
    ...
    internal static void Register()
    {
        ...
        EnhanceMicrophone = category.CreateEntry("EnhanceMicrophone", true);
    }

    internal static float SafeThreshold => float.IsFinite(ThresholdDb.Value) ? Math.Clamp(ThresholdDb.Value, -60, -10) : -40;
    internal static float SafeVolume => float.IsFinite(Volume.Value) ? Math.Clamp(Volume.Value, 0, 3) : 1;
